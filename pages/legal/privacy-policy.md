...
This Privacy Policy explains how personal data is collected, used, stored, and protected when you use Mind Measure. It also explains your rights in relation to that data and how others, including institutions that deploy Mind Measure, may receive aggregated insight derived from it.
...
- The Mind Measure websites (including mindmeasure.co.uk)
- Related services provided to students and institutions

Where Mind Measure is used as part of an institutional deployment, this policy applies to individual users of the app. Institutions receive aggregated, anonymised insight only, as described below.
...
- Produce aggregated, anonymised insight at cohort or population level for institutional dashboards
...
## 6. Aggregation and institutional insight

Mind Measure is designed to separate individual experience from institutional insight.

- Individual-level data remains private to you at all times
- Institutions receive aggregated, anonymised data only
- Minimum group thresholds are enforced before any data is surfaced to an institution; cohorts below this threshold are excluded from reporting
- Statistical noise may be applied to aggregated outputs to prevent inference
- Institutions cannot access individual responses, scores, check-in content, or media

There is no configuration, permission setting, or user role that allows institutional users to view individual student data. Personal wellbeing data and institutional reporting data are stored in separate database tables, accessed through separate roles, with strict row-level security enforced.

## 7. What institutions can and cannot access

Institutions may access:

- Aggregated wellbeing trends at cohort, programme, faculty, or population level
- Population-level patterns over time (e.g., by academic term or examination period)
- Comparative insight between cohorts, subject to minimum thresholds
- Aggregated linguistic themes (e.g., housing concerns, workload pressure, financial anxiety) at population level
- Engagement metrics showing platform adoption rates

Institutions cannot access:

- Individual check-in responses or content
- Individual Wellbeing Scores or trajectories
- Audio, video, or text inputs from any student
- Identifiable or re-identifiable personal data
- Real-time monitoring of any individual student

Institutional dashboards cannot be used for grading, discipline, progression decisions, or any purpose that would disadvantage individual students.
...
Your score is calibrated against your own personal baseline, which is established during your first interactions and evolves over time through longitudinal smoothing. This means the system detects changes relative to your own typical patterns, not compared to other students.

These outputs are informational only. They do not constitute a diagnosis, clinical assessment, or risk classification. No automated decisions with legal or similarly significant effects are made about you. No individual scores or signals are shared with your institution.
...
- Structural separation of personal data and aggregated institutional data in separate database tables
- Role-based access control with finely granulated permissions across multiple role types
- Row-level security ensuring each student can only access their own data
...
- Aggregated, anonymised institutional data: may be retained for trend analysis, as this data cannot be linked to any individual
...
Mind Measure is intended primarily for users aged 18 and over. We do not knowingly collect personal data from anyone under 18 outside of an institutional deployment.

Where students under the age of 18 access the Services as part of an institutional deployment, the following safeguards apply:

- The institution is responsible for ensuring appropriate consent and safeguarding arrangements are in place
- No institutional access to individual data is provided, regardless of the user's age
- Mind Measure does not send marketing communications to users under 18
- Mind Measure does not use automated decision-making about individual users of any age

If we learn that we have unknowingly collected personal data from someone under 18 outside an institutional context, we will delete that data as soon as possible.
...
| Dashboard hosting | Vercel | Institutional dashboard delivery | Aggregated, anonymised data only |
...
A full list of sub-processors is available on request to institutional partners.

## 16. Data Protection Impact Assessment

Given the nature of the data processed, including health-related data, audio and visual inputs, and automated analysis involving potentially vulnerable individuals, Mind Measure has conducted a Data Protection Impact Assessment (DPIA) in accordance with UK GDPR requirements. This assessment covers the processing of wellbeing data, the multimodal assessment engine, media handling and deletion practices, and the aggregation framework used to generate institutional insight.

The DPIA is available on request to institutional partners as part of the procurement and due diligence process.
