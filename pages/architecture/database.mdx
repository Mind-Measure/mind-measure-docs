...
<Callout type="info">**Legacy table.** This per-modality analysis table belongs to the earlier design. Current text analysis output is folded into `fusion_outputs` (and provenance metadata), produced by the Bedrock text pipeline (Claude Haiku 4.5). Access control is API-layer, not RLS.</Callout>
