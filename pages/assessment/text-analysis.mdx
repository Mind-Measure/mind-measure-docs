...
// Hardcoded in the mobile check-in text analyzer (bedrockTextAnalyzer.ts),
// distinct from the admin/back-office Bedrock model in api/_lib/bedrock-models.ts
...
*Model: Claude 3.7 Sonnet (anthropic.claude-3-7-sonnet-20250219-v1:0), the check-in text analyzer. The admin/back-office Bedrock model is separate (Claude Haiku 4.5). Canonical model table: [Platform handbook](/architecture/platform-handbook).*
